...
} from '@/modules/notifications/presentation/dto/list-notifications-query.dto';
import { Notification } from '@/modules/notifications/infrastructure/schemas/notification.schema';
import { NotificationReceipt } from '@/modules/notifications/infrastructure/schemas/notification-receipt.schema';
import { CreateNotificationInput } from '@/modules/notifications/application/types/create-notification-input.type';
import {
    NotificationItemResponse,
    NotificationListResponse,
    NotificationUnreadCountsResponse,
} from '@/modules/notifications/application/types/notification-response.type';
import { NotificationViewer } from '@/modules/notifications/application/types/notification-viewer.type';
...
export class NotificationsService {
    ...
    async list(
        ...
        const rows =
            await this.notificationModel.aggregate<NotificationAggregateRow>([
                { $match: match },
